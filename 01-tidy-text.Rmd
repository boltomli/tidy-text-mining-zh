...
图 @fig-plotcount-zh 展示了常见词词频。R 图形里中文字符的正确渲染依赖系统安装的 CJK 字体，这里使用 [Noto Sans CJK SC](https://github.com/notofonts/noto-cjk)（SIL Open Font License 1.1，自由使用、再分发与修改）。
...
ggplot(frequency, aes(x = proportion, y = `Various`, color = abs(`Various` - proportion))) +
  ...
  geom_text(aes(label = word), check_overlap = TRUE, vjust = 1.5, family = "Noto Sans CJK SC") +
