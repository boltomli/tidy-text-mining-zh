...
这些主题很清晰地与四本书联系了起来！“賈”无疑属于《紅樓夢》，“行者”应该属于《西遊記》，“兵”“將”属于《三國志演義》，而《水滸傳》。我们还可注意到，既然 LDA 属于“模糊聚类”方法，有些词为多个主题共有，如“道”属于主题1、3、4，“人”属于主题1、2、3。如果调整停止词以避免术语被过多主题共有，此结果当会有所不同。
...
assignments %>%
  ...
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, family = "WenQuanYi Micro Hei"),
